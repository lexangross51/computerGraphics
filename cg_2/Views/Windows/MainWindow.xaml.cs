...
public partial class MainWindow : IViewFor<MainViewModel>
{
    ...
    private readonly IBaseGraphic _renderServer = new RenderServer();
    ...
    public MainWindow()
    {
        ...
        this.Bind(ViewModel, viewModel => viewModel.DrawingViewModel.Camera, view => view._camera);
        this.Bind(ViewModel, viewModel => viewModel.DrawingViewModel.BaseGraphic,
            view => view._renderServer);
        this.Bind(ViewModel, viewModel => viewModel.DrawingViewModel.BaseGraphic.DeltaTime, view => view._deltaTime);
        InitializeComponent();
        this.WhenAnyValue(x => x.ViewModel!.DrawingViewModel.BaseGraphic.DeltaTime, x => _deltaTime = x);
    ...
    private void OnInitialize(object? sender, EventArgs e)
    {
        ...
        _renderServer.RenderObjects = renderables;
    }
